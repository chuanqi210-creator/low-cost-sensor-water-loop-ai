...
- core_score_termination_gate: `outputs/model_core_governance/core_score_termination_gate.json`
- external_activation_contract: `outputs/model_core_governance/external_activation_contract.json`
- external_activation_router: `outputs/model_core_governance/external_activation_router.json`
- external_activation_operator_action_packet: `outputs/model_core_governance/external_activation_operator_action_packet.json`
- field_activation_matrix: `outputs/model_core_governance/field_activation_matrix.json`
- stage_boundary_external_action_board: `outputs/model_core_governance/stage_boundary_external_action_board.json`
- stage_boundary_external_action_board_report: `deliverables/model_core_optimization/stage_boundary_external_action_board.md`
- new_core_interface_candidate_gate: `outputs/model_core_governance/new_core_interface_candidate_gate.json`
- new_core_interface_candidate_gate_report: `deliverables/model_core_optimization/new_core_interface_candidate_gate.md`
- external_package_readiness_board: `outputs/model_core_governance/external_package_readiness_board.json`
- external_package_readiness_board_report: `deliverables/model_core_optimization/external_package_readiness_board.md`
- external_package_operator_action_packet: `outputs/model_core_governance/external_package_operator_action_packet.json`
- external_package_operator_action_packet_report: `deliverables/model_core_optimization/external_package_operator_action_packet.md`
- external_package_acquisition_maturity_gate: `outputs/model_core_governance/external_package_acquisition_maturity_gate.json`
- external_package_acquisition_maturity_gate_report: `deliverables/model_core_optimization/external_package_acquisition_maturity_gate.md`
...
- grey_box_calibration_package_preflight: `outputs/grey_box_calibration_package/grey_box_calibration_package_preflight.json`
- grey_box_field_calibration_summary: `outputs/grey_box_calibration_package/grey_box_field_calibration_summary.json`
- grey_box_calibration_collection_work_order: `outputs/grey_box_calibration_package/grey_box_calibration_collection_work_order.json`
- grey_box_calibration_collection_work_order_report: `deliverables/model_core_optimization/grey_box_calibration_collection_work_order.md`
...
- field_supported_kg_edge_package_preflight: `outputs/field_supported_kg_edge_package/field_supported_kg_edge_package_preflight.json`
- sparse_topology_installability_package_preflight: `outputs/sparse_topology_installability_package/sparse_topology_installability_package_preflight.json`
- field_control_replay_package_preflight: `outputs/field_control_replay_package/field_control_replay_package_preflight.json`
- field_missingness_replay_package_preflight: `outputs/field_missingness_replay_package/field_missingness_replay_package_preflight.json`
- observation_response_bridge: `outputs/observation_response_bridge/observation_response_bridge_metrics.json`
- catalyst_evidence_response_gate: `outputs/catalyst_evidence_response_gate/catalyst_evidence_response_gate_metrics.json`
- catalyst_response_submission_kit: `outputs/catalyst_response_submission_kit/catalyst_response_submission_kit_metrics.json`
- focused_catalyst_response_merge: `outputs/focused_catalyst_response_merge/focused_catalyst_response_merge_preflight.json`
- focused_catalyst_response_repair_work_order: `outputs/focused_catalyst_response_merge/focused_catalyst_response_repair_work_order.json`
- catalyst_field_package_slice: `outputs/catalyst_field_package_slice/catalyst_field_package_slice_metrics.json`
- catalyst_slice_r7_patch_candidate: `outputs/catalyst_slice_r7_patch_candidate/catalyst_slice_r7_patch_candidate_metrics.json`
